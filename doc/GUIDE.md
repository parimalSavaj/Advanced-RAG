...
OPENROUTER_GRADING_MODEL=google/gemini-flash-1.5
...
- **For grading/classification tasks:** use `google/gemini-flash-1.5` (very cheap, fast)
- **For final answer generation:** use `google/gemini-2.0-flash-001` (excellent quality, affordable)
